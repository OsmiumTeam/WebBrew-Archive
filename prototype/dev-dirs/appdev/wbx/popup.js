const popup = {
	...
	open:function(url, width, height, title, icon="about:blank") {
		...
		windowdiv.setAttribute("class", "window glass")
		...
		maximize.setAttribute("class", "active")
		...
		windowdiv.setAttribute("onmousedown", "document.getElementById('window' + windows.ontop).setAttribute('class', 'window glass');windows.ontop = " + currenti + ";document.getElementById('window' + windows.ontop).setAttribute('class', 'window active glass');document.getElementById('window' + windows.ontop).style.zIndex = parseInt(parseInt(windows.topindex) + 1);windows.topindex = parseInt(parseInt(windows.topindex) + 1);")
